  ...
  return (
    <main className="flex w-full flex-col items-center justify-center gap-y-6 md:gap-y-10 lg:gap-y-12">
      <div className="flex flex-col items-center gap-y-4">
        ...
        <div className="text-text-secondary italic md:text-2xl lg:text-4xl">
          Some catchy tagline about how great I am.
        </div>
      </div>
      <div className="bg-accent h-1 w-32 lg:w-64" />
      <p className="text-text-secondary max-w-[500px] text-center text-sm md:text-base lg:text-lg">
